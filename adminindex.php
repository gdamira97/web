...
<body>
  <div class="bgimage"><img src="back.jpg" class="bgimage"></div>
      <div class="a">
      <ul>
    <li><a href="adminindex.php?page=index">Home</a></li>
    <li><a href="adminindex.php?page=post">Post</a></li>
    <li><a href="adminindex.php?page=job">Jobs</a></li>
    <button type="button" class="but" onclick="location.href='adminindex.php?page=postajob'">Post a Job</button>
        <ul style="float:right;list-style-type:none;">
          <li><form name="search" id="search" action="findadmin.php" method="post" target="_self">
    ...
    <article>
      <div class="carousel">  
        ...
        for($i=0;$i<$num;$i++){
          ...
          <div class="user"><a href="adminindex.php?page= <?= $row['useid'] ?>"><img src="<?= $myrow['profile'] ?>"><span><?= $myrow['name']." ".$myrow['surname'] ?></span></a><a href="like.php?id=<?= $row['id'] ?>" class = "fav">
            <?php
  ...
  <div class="gridcontainer">
    <div class="gridwrapper">
        ...
        <div class="gridbox gridmenu">
            ...
            <div class="menuitem"><a href="block.php?id=<?= $row['id'] ?>">
              <?php
              if($row['blocked'] == 1){
                ?>Blocked
                <?php
    ...
    <article>
      <div class="carousel">  
        ...
        for($i=0;$i<$num;$i++){
          ...
          <div class="im"> 
          <img src="<?= $image ?>" class="image"> 
          <div class="user"><a href="adminindex.php?page= <?= $row['userid'] ?>"><img src="<?= $myrow['profile'] ?>"><span><?= $myrow['name']." ".$myrow['surname'] ?></span></a><a href="like.php?id=<?= $row['id'] ?>" class = "fav">
            <?php
                if(in_array($row["id"], $like)){
                  ?><img src="liked.png" class="like">
                <?php
